...
# =============================================================================
    for d in range(n_D):
        ...
        x_D_T = syn_D_T['x']
        Is_D_T = syn_D_T['Is']
        Ipost_D_T = syn_D_T['Ipost']
            
    PSC_D_Thalamus[0][t - 1] = np.sum(Ipost_D_T)
...
# =============================================================================
    for tc in range(n_TC):
        ...
        syn_TC_D = tm_synapse_eq(r=rd, x=xd, Is=isd, AP=AP_TC, tau_f=t_f_E, tau_d=t_d_E, tau_s=t_s_E, U=U_E, A=A_T_D_E, dt=dt)
        r_TC_D = syn_TC_D['r']
        x_TC_D = syn_TC_D['x']
        Is_TC_D = syn_TC_D['Is']
        Ipost_TC_D = syn_TC_D['Ipost']
        
    PSC_TC[0][t - 1] = np.sum(Ipost_TC)
    PSC_TC_Cortex[0][t - 1] = np.sum(Ipost_TC_D)
# =============================================================================
# TR
# =============================================================================
