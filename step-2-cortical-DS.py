...
# =============================================================================
    for s in range(n_S):
        ...
        if (v_S_aux >= vp + zeta_S[s][t - 1]):
            ...
            v_S[s][t] = v_S_aux + dt*(dv_S + coupling_S_S + coupling_S_D + coupling_S_CI + coupling_S_T + kisi_S[s][t - 1] + I_ps_S[0][t - td_wl - td_syn - 1] - I_ps_S[1][t - td_wl - td_syn - 1])
...
# =============================================================================
    for d in range(n_D):
        ...
        if (v_D_aux >= vp + zeta_D[d][t - 1]):
            ...
            v_D[d][t] = v_D_aux + dt*(dv_D + coupling_D_S + coupling_D_D + coupling_D_CI + coupling_D_T + kisi_D[d][t - 1] + I_ps_D[0][t - td_wl - td_syn - 1] - I_ps_D[1][t - td_wl - td_syn - 1])
...
# =============================================================================
    for ci in range(n_CI):
        ...
        if (v_CI_aux >= vp + zeta_CI[ci][t - 1]):
            ...
            v_CI[ci][t] = v_CI_aux + dt*(dv_CI + coupling_CI_CI + coupling_CI_S + coupling_CI_D + coupling_CI_T + kisi_CI[ci][t - 1] + I_ps_CI[0][t - td_wl - td_syn - 1] - I_ps_CI[0][t - td_wl - td_syn - 1])
