...
print_comparison(voltage = v[0], PSC = PSC_E_D[0], title = 'Thalamo Cortical - Excitatory - Depression')
print_comparison(voltage = v[0], PSC = PSC_E_F[0], title = 'Thalamo Cortical - Excitatory - Facilitation')
print_comparison(voltage = v[0], PSC = PSC_I_D[0], title = 'Thalamo Cortical - Inhibitory - Depression')
print_comparison(voltage = v[0], PSC = PSC_I_F[0], title = 'Thalamo Cortical - Inhibitory - Facilitation')
